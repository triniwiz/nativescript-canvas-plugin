...
function preload() {
    ...
    this.load.image(assets.scene.background.day, func.uri('~/flappybird/assets/background-day.png'))
    this.load.image(assets.scene.background.night, '~/flappybird/assets/background-night.png')
    this.load.spritesheet(assets.scene.ground, '~/flappybird/assets/ground-sprite.png', {
        frameWidth: 336,
        frameHeight: 112
    })

    // Pipes
    this.load.image(assets.obstacle.pipe.green.top, '~/flappybird/assets/pipe-green-top.png')
    this.load.image(assets.obstacle.pipe.green.bottom, '~/flappybird/assets/pipe-green-bottom.png')
    this.load.image(assets.obstacle.pipe.red.top, '~/flappybird/assets/pipe-red-top.png')
    this.load.image(assets.obstacle.pipe.red.bottom, '~/flappybird/assets/pipe-red-bottom.png')

    // Start game
    this.load.image(assets.scene.messageInitial, '~/flappybird/assets/message-initial.png')

    // End game
    this.load.image(assets.scene.gameOver, '~/flappybird/assets/gameover.png')
    this.load.image(assets.scene.restart, '~/flappybird/assets/restart-button.png')

    // Birds
    this.load.spritesheet(assets.bird.red, '~/flappybird/assets/bird-red-sprite.png', {
        frameWidth: 34,
        frameHeight: 24
    })
    this.load.spritesheet(assets.bird.blue, '~/flappybird/assets/bird-blue-sprite.png', {
        frameWidth: 34,
        frameHeight: 24
    })
    this.load.spritesheet(assets.bird.yellow, '~/flappybird/assets/bird-yellow-sprite.png', {
        frameWidth: 34,
        frameHeight: 24
    })

    // Numbers
    this.load.image(assets.scoreboard.number0, '~/flappybird/assets/number0.png')
    this.load.image(assets.scoreboard.number1, '~/flappybird/assets/number1.png')
    this.load.image(assets.scoreboard.number2, '~/flappybird/assets/number2.png')
    this.load.image(assets.scoreboard.number3, '~/flappybird/assets/number3.png')
    this.load.image(assets.scoreboard.number4, '~/flappybird/assets/number4.png')
    this.load.image(assets.scoreboard.number5, '~/flappybird/assets/number5.png')
    this.load.image(assets.scoreboard.number6, '~/flappybird/assets/number6.png')
    this.load.image(assets.scoreboard.number7, '~/flappybird/assets/number7.png')
    this.load.image(assets.scoreboard.number8, '~/flappybird/assets/number8.png')
    this.load.image(assets.scoreboard.number9, '~/flappybird/assets/number9.png')
}
