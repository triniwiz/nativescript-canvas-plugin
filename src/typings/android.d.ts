		...
		export module triniwiz {
			export module canvas {
				export class ImageData {
					...
					public updateData(param0: native.Array<number>): void;
					public getHeight(): number;
		...
		export module triniwiz {
			export module canvas {
				export class WebGL2RenderingContext extends com.github.triniwiz.canvas.WebGLRenderingContext {
					...
					public QUERY_COUNTER_BITS: number;
					public QUERY_COUNTER_BITS_EXT: number;
		...
		export module triniwiz {
			export module canvas {
				export class WebGLRenderingContext extends com.github.triniwiz.canvas.CanvasRenderingContext {
					...
					public COMPRESSED_RGBA_ASTC_4x4_KHR: number;
					public COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR: number;
					public COMPRESSED_RGBA_ASTC_5x4_KHR: number;
					public COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR: number;
					public COMPRESSED_RGBA_ASTC_5x5_KHR: number;
					public COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR: number;
					public COMPRESSED_RGBA_ASTC_6x5_KHR: number;
					public COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR: number;
					public COMPRESSED_RGBA_ASTC_6x6_KHR: number;
					public COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR: number;
					public COMPRESSED_RGBA_ASTC_8x5_KHR: number;
					public COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR: number;
					public COMPRESSED_RGBA_ASTC_8x6_KHR: number;
					public COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR: number;
					public COMPRESSED_RGBA_ASTC_8x8_KHR: number;
					public COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR: number;
					public COMPRESSED_RGBA_ASTC_10x5_KHR: number;
					public COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR: number;
					public COMPRESSED_RGBA_ASTC_10x6_KHR: number;
					public COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR: number;
					public COMPRESSED_RGBA_ASTC_10x10_KHR: number;
					public COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR: number;
					public COMPRESSED_RGBA_ASTC_12x10_KHR: number;
					public COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR: number;
					public COMPRESSED_RGBA_ASTC_12x12_KHR: number;
					public COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR: number;
					public COMPRESSED_RGBA_BPTC_UNORM_EXT: number;
					public COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT: number;
					public COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT: number;
					public COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT: number;
					public COMPRESSED_RED_RGTC1_EXT: number;
					public COMPRESSED_SIGNED_RED_RGTC1_EXT: number;
					public COMPRESSED_RED_GREEN_RGTC2_EXT: number;
					public COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT: number;
					public ALPHA: number;
					public RGB: number;
					public RGBA: number;
