...
export class TNSCanvasRenderingContext2D extends TNSCanvasRenderingContext2DBase {
    ...
    set fillStyle(color: string | CanvasGradient | CanvasPattern) {
        ...
        if (!(color instanceof CanvasGradient || color instanceof CanvasPattern) && TNSCanvasRenderingContext2D.colorCache[color]) {
            const cache = TNSCanvasRenderingContext2D.colorCache[color];
        ...
        if (color instanceof CanvasGradient) {
            ...
            TNSCanvasRenderingContext2D.colorCache[color] = nativeStyle;
        }
